...
local function BuildUI()
    ...
    movementSection.Size = UDim2.new(1, -10, 0, 160)
    ...
    heightInput.Position = UDim2.new(0, 80, 0, 135)
    heightInput.Text = "16"
    ...
    weatherSection.Position = UDim2.new(0, 5, 0, 745) -- Moved down to accommodate movement section
    ...
    featureScrollFrame.CanvasSize = UDim2.new(0, 0, 0, 880) -- Increased to accommodate movement section
