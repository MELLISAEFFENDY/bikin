    ...
    while AutoSell.enabled and AutoSell.sessionId == mySessionId do
        ...
        if currentItems and maxItems then
            ...
            if percentage >= AutoSell.sellAtPercent then
                Notify("Auto Sell", string.format("Inventory at %.0f%%. Triggering sell.", percentage))
                SellItemsByRarity()
            end
        end
...
local function BuildUI()
    ...
    autoSellSection.Size = UDim2.new(1, -10, 0, 180)
    ...
    rarityTogglesFrame.Position = UDim2.new(0, 10, 0, 90)
    ...
    antiAfkSection.Position = UDim2.new(0, 5, 0, 585) -- Adjusted position
    ...
    fishingAIScrollFrame.CanvasSize = UDim2.new(0, 0, 0, 655) -- Increased canvas size
