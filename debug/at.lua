    ...
    for _, descendant in pairs(ReplicatedStorage:GetDescendants()) do
        pcall(function()
            if descendant:IsA("RemoteFunction") then
                ...
                local success, originalInvoke = pcall(function() return descendant.InvokeServer end)
                
                if success and originalInvoke then
            ...
            elseif descendant:IsA("RemoteEvent") then
                local remoteName = descendant.Name
                local success, originalFire = pcall(function() return descendant.FireServer end)
                
                if success and originalFire then
