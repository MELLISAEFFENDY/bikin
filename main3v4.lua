...
local function FixRodOrientation()
    ...
    if rightArm then
        ...
        if rightGrip and rightGrip:IsA("Motor6D") then
            -- FIXED: Orientasi yang benar untuk rod menghadap depan seperti auto bawaan game
            -- C0 mengontrol posisi/orientasi di right arm
            -- C1 mengontrol posisi/orientasi di handle
            -- Orientasi untuk menghadap depan: rotasi Y 180 derajat
            rightGrip.C0 = CFrame.new(0, -1, 0) * CFrame.Angles(math.rad(-90), math.rad(180), 0)
    ...
    if handle then
        ...
        if toolGrip and toolGrip:IsA("CFrameValue") then
            -- FIXED: Grip value untuk rod menghadap depan seperti auto bawaan game
            toolGrip.Value = CFrame.new(0, -1.5, 0) * CFrame.Angles(math.rad(-90), math.rad(180), 0)
            return
        end
